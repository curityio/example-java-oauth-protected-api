...
{
    private static Logger _logger = LoggerFactory.getLogger(OAuthFilter.class);
     ...
     */
    protected abstract String getOAuthHost();
     ...
     */
    protected abstract @Nonnull String[] getScopes();
     ...
     */
    protected boolean authorize(@Nullable String scopesInToken)
    {
        ...
        String[] presentedScopes = scopesInToken.split("\\s+");
        List<String> presentedScopesList = Arrays.asList(presentedScopes);
